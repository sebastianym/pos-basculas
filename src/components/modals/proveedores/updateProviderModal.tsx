import updateProviderAction from "@/data/actions/proveedor/updateProviderAction";
...
function UpdateProviderModal({
  ...
  useEffect(() => {
    if (formState.success) {
      ...
      successAlert(
        "Éxito",
        "Proveedor actualizado correctamente. Redirigiendo a la lista de proveedores.",
        "success"
      );
      setNombre("");
      setDireccion("");
          ...
          <div className="bg-background rounded-lg w-full max-w-md p-6 relative">
            ...
            <div className="mt-4">
              <form action={formAction}>
                <input type="hidden" name="id" defaultValue={proveedor?.id} />
                <div className="mb-4">
